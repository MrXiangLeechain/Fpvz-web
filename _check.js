...
const LEVELS=[
  {name:"第 1 关 · 后院初见", plants:["sunflower","peashooter"], startSun:150, skySun:true,
   waves:[{t:8,z:{normal:1}},{t:21,z:{normal:2}},{t:33,z:{normal:3}},{t:44,z:{normal:4}},{t:53,z:{normal:6},final:true}]},
  {name:"第 2 关 · 路障来袭", plants:["sunflower","peashooter","wallnut"], startSun:100, skySun:true,
   waves:[{t:8,z:{normal:2}},{t:21,z:{normal:2,cone:1}},{t:33,z:{cone:2,normal:2}},{t:44,z:{normal:3,cone:2}},{t:53,z:{cone:3,normal:3}},{t:61,z:{cone:4,normal:5},final:true}]},
  {name:"第 3 关 · 铁桶压境", plants:["sunflower","peashooter","wallnut","snowpea"], startSun:100, skySun:true,
   waves:[{t:8,z:{normal:2,cone:1}},{t:21,z:{cone:2,normal:2}},{t:33,z:{bucket:1,normal:3}},{t:44,z:{bucket:2,cone:2}},{t:53,z:{bucket:2,cone:3,normal:3}},{t:61,z:{bucket:3,cone:3,normal:4},final:true}]},
  {name:"第 4 关 · 疾影夜袭", plants:["sunflower","peashooter","wallnut","snowpea","cherry"], startSun:125, skySun:true,
   waves:[{t:7,z:{runner:2,normal:1}},{t:19,z:{cone:2,runner:2}},{t:30,z:{bucket:2,runner:3}},{t:40,z:{cone:3,runner:3,normal:2}},{t:48,z:{bucket:3,cone:2,runner:3}},{t:55,z:{bucket:3,cone:4,runner:4},final:true}]},
  {name:"第 5 关 · 决战黎明", plants:["sunflower","peashooter","wallnut","snowpea","cherry","repeater"], startSun:125, skySun:true,
   waves:[{t:6,z:{normal:2,cone:2}},{t:20,z:{cone:3,runner:2}},{t:33,z:{bucket:2,cone:3}},{t:44,z:{runner:4,cone:4}},{t:54,z:{bucket:3,cone:4,normal:3}},{t:63,z:{bucket:4,cone:4,runner:4}},{t:71,z:{bucket:4,cone:5,runner:5}},{t:78,z:{bucket:5,cone:5,normal:6},final:true}]},
];
...
function update(dt){
  ...
  while(G.waveIdx<lv.waves.length && G.time>=lv.waves[G.waveIdx].t){
    ...
    if(w.final){ flashText("🚩 最后一大波僵尸来袭！",W/2,200,"#ff7b6b",30,3); SFX.wave(); }
    G.waveIdx++;
  }
  ...
  for(let r=0;r<ROWS;r++) for(let c=0;c<COLS;c++){
    ...
    if(pl.type==="sunflower"){
      pl.timer+=dt;
      if(pl.timer>=13.25){ pl.timer=0; spawnSun(cellCX(c)+28,cellCY(r)-20,cellCY(r)+18,true); }
    }else if(def.dmg){
      pl.fireT-=dt;
